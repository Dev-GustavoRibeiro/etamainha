...
<head>
    ...
    <title>Eita Mainha - Kit Festas</title>
...
<header class="header">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="icons d-flex align-items-center">
            <a href="../api/login.php" class="icon" aria-label="Login"><img src="../icons/usuário.png" alt="Ícone de usuário"></a>
...
<div id="search-bar" class="search-bar">
    <div class="container my-4">
        <form class="d-flex justify-content-center" method="GET" action="kit_festas.php">
...
<div id="side-menu" class="side-menu">
    ...
    <h1 class="text-center">Kit Festas</h1>
    <div class="row">
        <?php
        $search = $_GET['search'] ?? '';
        $query = "
            SELECT * 
            FROM produtos 
            WHERE categoria_id = (SELECT id FROM categorias WHERE nome = 'Kit Festas')
            AND nome LIKE ?";
