...
<head>
    ...
    <title>Eita Mainha - Coffe Break</title>
...
<div id="search-bar" class="search-bar">
    <div class="container my-4">
        <form class="d-flex justify-content-center" method="GET" action="doces.php">
            <input type="text" name="search" class="form-control w-50" placeholder="Pesquise por doces..." value="<?= htmlspecialchars($_GET['search'] ?? '') ?>">
...
<div id="side-menu" class="side-menu">
    ...
    <div>
            ...
            <ul class="menu-links">
                ...
                <li><a href="coffee_break.php">Coffee Break</a></li>
    ...
    <h1 class="text-center">Coffee Break</h1>
    <div class="row">
        <?php
        $search = $_GET['search'] ?? '';
        $query = "
            SELECT * 
            FROM produtos 
            WHERE categoria_id = (SELECT id FROM categorias WHERE nome = 'Coffee Break')
            AND nome LIKE ?";
